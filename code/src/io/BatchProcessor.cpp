...
std::vector<Section> allSections() {
    return {
        ...
        { "edge_cases", {
            ...
            // phantom (BCT-Color)
            {"edge_cases/ranges/disconnected.txt",      "edge_cases/registers/phantom1.txt",
             "phantom/disconnected/1reg",      "yes", 1, -1, "disconnected_phantom1.txt"},
            {"edge_cases/ranges/no_interference.txt",   "edge_cases/registers/phantom1.txt",
             "phantom/no_interference/1reg",   "yes", 1, -1, "no_interference_phantom1.txt"},
            {"edge_cases/ranges/same_line_def_use.txt", "edge_cases/registers/phantom1.txt",
             "phantom/same_line_def_use/1reg", "yes", 1, -1, "same_line_def_use_phantom1.txt"},
            {"edge_cases/ranges/dsatur_dense.txt",      "edge_cases/registers/phantom4.txt",
             "phantom/dsatur_dense/4regs",     "yes", 4, -1, "dsatur_dense_phantom4.txt"},
            {"edge_cases/ranges/dsatur_dense.txt",      "edge_cases/registers/phantom3.txt",
             "phantom/dsatur_dense/3regs",     "yes", 3, -1, "dsatur_dense_phantom3.txt"},
            {"edge_cases/ranges/spill_basic.txt",       "edge_cases/registers/phantom2.txt",
             "phantom/spill_basic/2regs",      "yes", 2, -1, "spill_basic_phantom2.txt"},
            {"edge_cases/ranges/spill_exceeds_k.txt",   "edge_cases/registers/phantom2.txt",
             "phantom/spill_exceeds/2regs",    "", -1, -1,   "spill_exceeds_k_phantom2.txt"},
            {"edge_cases/ranges/web_merge_chain.txt",   "edge_cases/registers/phantom2.txt",
             "phantom/web_merge_chain/2regs",  "", -1, -1,   "web_merge_chain_phantom2.txt"},
        }},
        { "hourglass", {
            {"hourglass/ranges/hourglass1.txt", "hourglass/registers/basic3.txt",
             "h1-basic3", "yes", -1, 3, "hourglass1_basic3.txt"},
            {"hourglass/ranges/hourglass1.txt", "hourglass/registers/phantom3.txt",
             "h1-phantom3",  "yes", -1, 3, "hourglass1_phantom3.txt"},
            ...
            {"hourglass/ranges/hourglass2.txt", "hourglass/registers/phantom4.txt",
             "h2-phantom4",  "yes", -1, 4, "hourglass2_phantom4.txt"},
            {"hourglass/ranges/hourglass2.txt", "hourglass/registers/basic3.txt",
             "h2-basic3", "no",  -1,-1, "hourglass2_basic3.txt"},
            {"hourglass/ranges/hourglass3.txt", "hourglass/registers/phantom3.txt",
             "h3-phantom3",  "yes", -1, 3, "hourglass3_phantom3.txt"},
            {"hourglass/ranges/hourglass4.txt", "hourglass/registers/phantom3.txt",
             "h4-phantom3",  "yes", -1, 3, "hourglass4_phantom3.txt"},
            {"hourglass/ranges/hourglass5.txt", "hourglass/registers/phantom4.txt",
             "h5-phantom4",  "yes", -1, 4, "hourglass5_phantom4.txt"},
            {"hourglass/ranges/hourglass5.txt", "hourglass/registers/basic4.txt",
             "h5-basic4", "yes", -1, 4, "hourglass5_basic4.txt"},
        }},
        { "stress", {
            {"stress/ranges/path10.txt",      "stress/registers/phantom2.txt",  "path10-phantom2",      "yes", -1, 2, "path10_phantom2.txt"},
            {"stress/ranges/ladder.txt",      "stress/registers/phantom2.txt",  "ladder-phantom2",      "yes",  2,-1, "ladder_phantom2.txt"},
            {"stress/ranges/star_k1_8.txt",   "stress/registers/phantom2.txt",  "star_k1_8-phantom2",   "yes",  2,-1, "star_k1_8_phantom2.txt"},
            {"stress/ranges/five_k3.txt",     "stress/registers/phantom3.txt",  "five_k3-phantom3",     "yes", -1, 3, "five_k3_phantom3.txt"},
            {"stress/ranges/deep_chain.txt",  "stress/registers/phantom3.txt",  "deep_chain-phantom3",  "yes", -1, 3, "deep_chain_phantom3.txt"},
            {"stress/ranges/wheel5.txt",      "stress/registers/phantom3.txt",  "wheel5-phantom3",      "yes", -1, 3, "wheel5_phantom3.txt"},
            {"stress/ranges/five_k3.txt",     "stress/registers/basic2.txt", "five_k3-basic2",    "no",  -1,-1, "five_k3_basic2.txt"},
            {"stress/ranges/k4_edge_share.txt",     "stress/registers/phantom4.txt",  "k4_edge_share-phantom4",     "yes", 4,-1, "k4_edge_share_phantom4.txt"},
            {"stress/ranges/triple_hourglass.txt",  "stress/registers/phantom4.txt",  "triple_hourglass-phantom4",  "yes",-1, 4, "triple_hourglass_phantom4.txt"},
            {"stress/ranges/asym_hourglass.txt",    "stress/registers/phantom4.txt",  "asym_hourglass-phantom4",    "yes",-1, 4, "asym_hourglass_phantom4.txt"},
            {"stress/ranges/conflict_pressure.txt", "stress/registers/phantom4.txt",  "conflict_pressure-phantom4", "yes",-1, 4, "conflict_pressure_phantom4.txt"},
            {"stress/ranges/k4_edge_share.txt",     "stress/registers/basic3.txt", "k4_edge_share-basic3",    "no", -1,-1, "k4_edge_share_basic3.txt"},
        }},
        { "adversarial", {
            // χ=2
            {"adversarial/ranges/large_bipartite.txt", "adversarial/registers/phantom2.txt",
             "large_bipartite-phantom2", "yes", 2,-1, "large_bipartite_phantom2.txt"},
            {"adversarial/ranges/six_k2.txt",          "adversarial/registers/phantom2.txt",
             "six_k2-phantom2",          "yes", 2,-1, "six_k2_phantom2.txt"},
            {"adversarial/ranges/six_k2.txt",          "adversarial/registers/phantom1.txt",
             "six_k2-phantom1",          "yes", 1,-1, "six_k2_phantom1.txt"},
            // χ=3
            {"adversarial/ranges/petersen.txt",     "adversarial/registers/phantom3.txt",
             "petersen-phantom3",     "yes", 3,-1, "petersen_phantom3.txt"},
            {"adversarial/ranges/petersen.txt",     "adversarial/registers/phantom2.txt",
             "petersen-phantom2",     "yes", 2,-1, "petersen_phantom2.txt"},
            {"adversarial/ranges/odd_cycle_c7.txt", "adversarial/registers/phantom3.txt",
             "odd_cycle_c7-phantom3", "yes",-1, 3, "odd_cycle_c7_phantom3.txt"},
            {"adversarial/ranges/odd_cycle_c9.txt", "adversarial/registers/phantom3.txt",
             "odd_cycle_c9-phantom3", "yes",-1, 3, "odd_cycle_c9_phantom3.txt"},
            {"adversarial/ranges/mycielski_c5.txt", "adversarial/registers/phantom3.txt",
             "mycielski_c5-phantom3", "yes", 3,-1, "mycielski_c5_phantom3.txt"},
            {"adversarial/ranges/zigzag.txt",       "adversarial/registers/phantom3.txt",
             "zigzag-phantom3",       "yes",-1, 3, "zigzag_phantom3.txt"},
            {"adversarial/ranges/fat_ap_star.txt",  "adversarial/registers/phantom3.txt",
             "fat_ap_star-phantom3",  "yes", 3,-1, "fat_ap_star_phantom3.txt"},
            {"adversarial/ranges/chain_20_k3.txt",  "adversarial/registers/phantom3.txt",
             "chain_20_k3-phantom3",  "yes",-1, 3, "chain_20_k3_phantom3.txt"},
            {"adversarial/ranges/pure_c21.txt",     "adversarial/registers/phantom3.txt",
             "pure_c21-phantom3",     "yes",-1, 3, "pure_c21_phantom3.txt"},
            // χ=4
            {"adversarial/ranges/grotzsch.txt",            "adversarial/registers/phantom4.txt",
             "grotzsch-phantom4",            "yes",-1, 4, "grotzsch_phantom4.txt"},
            {"adversarial/ranges/grotzsch.txt",            "adversarial/registers/phantom3.txt",
             "grotzsch-phantom3",            "yes", 3,-1, "grotzsch_phantom3.txt"},
            {"adversarial/ranges/k4_chain.txt",            "adversarial/registers/phantom4.txt",
             "k4_chain-phantom4",            "yes", 4,-1, "k4_chain_phantom4.txt"},
            {"adversarial/ranges/k4_chain_10.txt",         "adversarial/registers/phantom4.txt",
             "k4_chain_10-phantom4",         "yes", 4,-1, "k4_chain_10_phantom4.txt"},
            {"adversarial/ranges/ap_color_conflict.txt",   "adversarial/registers/phantom4.txt",
             "ap_color_conflict-phantom4",   "yes", 4,-1, "ap_color_conflict_phantom4.txt"},
            {"adversarial/ranges/double_ap_shared.txt",    "adversarial/registers/phantom4.txt",
             "double_ap_shared-phantom4",    "yes", 4,-1, "double_ap_shared_phantom4.txt"},
            {"adversarial/ranges/w_shape_4ap.txt",         "adversarial/registers/phantom4.txt",
             "w_shape_4ap-phantom4",         "yes", 4,-1, "w_shape_4ap_phantom4.txt"},
            {"adversarial/ranges/two_k4_shared_edge.txt",  "adversarial/registers/phantom4.txt",
             "two_k4_shared_edge-phantom4",  "yes", 4,-1, "two_k4_shared_edge_phantom4.txt"},
            {"adversarial/ranges/three_k4_bridges.txt",    "adversarial/registers/phantom4.txt",
             "three_k4_bridges-phantom4",    "yes", 4,-1, "three_k4_bridges_phantom4.txt"},
            {"adversarial/ranges/dense_sparse_mix.txt",    "adversarial/registers/phantom4.txt",
             "dense_sparse_mix-phantom4",    "yes", 4,-1, "dense_sparse_mix_phantom4.txt"},
            {"adversarial/ranges/dense_k4partite_100.txt", "adversarial/registers/phantom4.txt",
             "dense_k4partite-phantom4",     "yes", 4,-1, "dense_k4partite_100_phantom4.txt"},
            // χ=5
            {"adversarial/ranges/mycielski_m4.txt", "adversarial/registers/phantom5.txt",
             "mycielski_m4-phantom5", "yes", 5,-1, "mycielski_m4_phantom5.txt"},
            {"adversarial/ranges/mycielski_m4.txt", "adversarial/registers/phantom4.txt",
             "mycielski_m4-phantom4", "yes", 4,-1, "mycielski_m4_phantom4.txt"},
        }},
    };
}
